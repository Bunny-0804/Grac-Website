...
const deleteMember = async (req, res) => {
    ...
    try {
        const data = req.body;
        const result = await db.query(query.addtask , [data.task_description , data.task_assignment_date , data.task_due_date , data.project_id , data.completion_weightage]);
